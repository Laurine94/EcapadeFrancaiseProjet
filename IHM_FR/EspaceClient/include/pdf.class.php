...
class PDF extends FPDF
{
    ...
    function data($data)
    {
        ...
        foreach($data as $fil)
        {
            $this->Cell(45,10, utf8_decode($fil['libelle']),1, 0 , 'C' );
            $this->Cell(45,10, utf8_decode($fil['quantite']),1, 0 , 'C' );
            $this->Cell(45,10, utf8_decode($fil['montant']),1, 0 , 'C' );
            $this->Cell(45,10, utf8_decode($fil['montant'])* utf8_decode($fil['quantite']),1, 0 , 'C' );
            $this->Ln();
        }
