    ...
    <div class="grande_div">
        ...
        <form action="" method="">
                    ...
                    <div class="upload_div">
                        <label for="file" class="label-file"><img src="img/logos/upload-button.png"> Téléchargez le contrat signé </label>
                        <input id="file" class="input-file" type="file">
                        <br />
                        <br />
                        <br />
                        <label for="file" class="label-file"><img src="img/logos/upload-button.png"> Téléchargez la charte signée</label>
                        <input id="file" class="input-file" type="file">
                    </div>
