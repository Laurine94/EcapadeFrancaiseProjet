...
<html>
    ...
    <body>
		...
		<br>
        	...
        	<div class="phrase">
            	<h2 style="'Arial', sans-sherif; color:#999 ; margin-left:5%">         Sélectionner une ville </h2>
        	</div>
...
?>
	...
	<br>
	<br>
	<div style="height: auto; width:100%; background-position: center bottom; opacity:1.75; background-image: url(<?php echo 'img/fondsactivites/'.$sel_city.'_fond.jpg';?>); background-size: cover; padding-bottom: 50px;">
		<br>
		<br>
		<br>
        <div class="phrase">
            <h1 style="color:#C70039">Sélectionner une langue </h1>
        </div>
        ...
        <div class="phrase">
            <h1 style="color:#C70039">Liste des guides</h1>
        </div>
