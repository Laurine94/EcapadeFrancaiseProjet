...
<?php 
   ...
   echo '<div class="panier" id="sticky"><a href="confirm.php" title="Check your reservation"><p><U><strong>Votre réservation :</strong></U> &nbsp;&nbsp;&nbsp; Chambres (' . $nb_guesthouse . ') | Activités (' . $nb_activity . ')</p></a></div>';
?>