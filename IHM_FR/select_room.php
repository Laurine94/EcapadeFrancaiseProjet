            ...
            <ul class="menu_guesthouse">
                ...
                <?php
                    ...
                    while ($nom_ville = $back->fetch()){
                        echo '<li><a href="select_guesthouse.php?ville=' . $nom_ville['ville'] . '" style="text-decoration:none;color:grey;">2. Choisissez votre maison d\'hôtes</a></li>';
                    }
                ?>
                
                <li class="guesthouse_active">3. Réservez votre chambre</li>
                <li>4. Confirmez</li>
            </ul>
        </div>
        <br /><br />
...
<div class="div_25 toSize">
    <div class="sous_div">
        <p style="font-weight:bold; font-size:18px; text-align: center;">Selectionnez vos dates de visites:</p>
        <form action="fonctionAdd.php" method="get">
            ...
            <br /><br />
            Capacité : <?php echo $donnees['nb_places']; ?> personne(s).
            <br /><br />
...
?>
            ...
            <a><input type="submit" value="Réserver" class="submit_btn"/></a>
        </form>
        <br /><br />
    </div>
</div>
...
<p>L'heure d'arrivée est à <?php echo $donnees['heure_arr']; ?> et l'heure de départ est à <?php echo $donnees['heure_dep']; ?>.<br /></p>
