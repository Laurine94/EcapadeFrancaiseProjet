...
if(d1>d2)
{	
	echo "Vous avez sélectionnez une date incorrect!!";
}
else
{
	alert('Correct')
                        ...
                        <p style="font-weight:bold; font-size:18px; text-align: center;">Selection your visit date:</p>
                            <form action="fonctionAdd.php" method="get">
                                ...
                                <label class="label" for="date_debut">
                                    Arrival date :<br />
                                    <input type="text"  value="Wrong date!" class="calendrier" id="date_debut<?php echo $a; ?>" name="date_debut" required>
                                  
                                </label>
                                <br /><br />
                                <label class="label" for="date_fin">
                                    Departure date :<br />
                                    <input type="text"  value="Wrong date!" class="calendrier" id="date_fin<?php echo $a; ?>" name="date_fin" required/>
                                </label>
                                <script>
...
else
{
    alert('Correct')
                                ...
                                <br /><br />
				<div>
                                    Number of persons: <select name="nb_places" style="color: black">
				    <?php for ($p = 1; $p <= $donnees['nb_places']; $p++)
					echo "<option value=$p>$p</option>";
				    ?>
				    
				    <input type="checkbox" name="with-babies" class="pull-right"/><span class="pull-right">Bébé (- 3 ans)</span>
				  </div>
                                <br /><br />
