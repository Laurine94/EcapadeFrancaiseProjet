                    ...
                    <div class="tableau_select_region">
                        <?php
                            ...
                            while ($donnees = $req->fetch()) {
                                if (file_exists('img/genrebis/'.$donnees['genre'].'.jpg')) echo '
                                        <div class="bloc5">
                                            <a href="select_activities.php?genre='.$donnees['genre'].'">
                                                <img src="img/genrebis/'.$donnees['genre'].'.jpg" alt="'.$donnees['genre'].'"/>
                                                <div class="overlay">
