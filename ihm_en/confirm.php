        ...
        <table style="width: 90%; margin: auto;">
            ...
            <div class="payment_btn">
                ...
                if (!isset($_SESSION['id'])) {
                    ?>
                    <a class="btn btn-primary" href="EspaceClient/indexClient.php?uc=connexion&action=demandeConnexion" role="button"><input type="button" class="submit_btn" value="Confirm"></a>
                    <?php
                } else {
                    if (!isset($_COOKIE['guesthouse']) == TRUE) {
                        ?>
                        <a class="btn btn-primary" href="customer_infos.php" role="button"><input type="button" class="submit_btn" value="Confirm"></a>
                    <?php } else { ?>
                        <!-- Bouton execution modal -->
                        <button class="btn btn-primary " style="background-color:#284777"data-toggle="modal" data-target="#myModal">
                                Confirm
                            </button>
