    ...
    <body>
    	...
    	<?php
			...
			while ($donnees = $req->fetch()) {
				if (file_exists('img/villes_activites/'.$donnees['id'].'_guide.jpg')) echo '
            		<div class="bloc1">
						<a href="?city='.$donnees['id'].'"><img src="img/villes_activites/'.$donnees['id'].'_guide.jpg" alt="'.$donnees['ville'].'"/>
							<div class="overlay">
