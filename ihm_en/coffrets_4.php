   ...
   <div class="case2">
     <div class="container">
       <div class="row">
         <div class="col-md-6">
           <div class="box1">
              <img src="img/cadeaux/cadeau3.jpg" class="img-thumbnail">
         ...
         <div class="col-md-6">
           <div class="box2">
             <h1>COFFRET ILE DE LA REUNION</h1>
             <br>
             <br>
             <br>
             <p>UGS : 0004</p>
            ...
            <div class="modal-content">
              ...
              <img src="img/cadeaux/cadeau3.jpg " class="img-thumbnail" width="300px;" height="400px;" style="align-items: center; margin-left:13%" class="zoom">
              <div class="modal-body">
                    <br>
                    <p style="font-weight:bold;">COFFRET ILE DE LA REUNION</p>
                    <br>
                    <P>Quantity :</P>
                    <br>
                    <p>Price : </p>
