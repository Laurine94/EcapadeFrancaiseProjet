...
#sub #circle:hover > a {
 ...
 <div class="case1 background">
        <div class="carre1">
        	<div class="border">
        		<h1 style="color: #183e67;">La collection <br>d'Escapade <br>Coffrets</h1>
          		<h3 style="color: #183e67;">FAIT MAIN - FAIT AVEC AMOUR</h3>
        	</div>
        </div>
  </div>
  <!--case02-->
  <div class="case2" id=shop name=shop>
  		<div class="parti">
      <br>
  			<h1 style="color: #183e67;">La collection par Lisa Bouillon</h1>
        <br>
        <br>
        <br>
  				<div class="container">
              ...
              <?php foreach ($coffret as $coffret): ?>
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <div class="view">
                    ...
                    <div class="middle">
                      <button class="text"><a href="coffrets_<?= $coffret->id; ?>.php">VOIR CE COFFRET</a></button>
                    </div>
                    ...
                    <div id="button1" style="background-color:#183e67; height:25px;">
                      ...
                      <p style="margin-top:-2%; color:white;">AJOUTER AU PANIER</p></a>
                    </div>  
                    <br>
                    <br>     
                    <br>  
        ...
        <ul class="style-ih1tlgxx_orientation-right style-ih1tlgxx_text-align-right style-ih1tlgxxmenuContainer" id="comp-igqd3whfmenuContainer">
          <li class="style-ih1tlgxx_item">
            <a class="style-ih1tlgxx_link" aria-labelledby="anchor-label_1" href="#" target="_self" data-keep-roots="true" data-anchor="SCROLL_TO_TOP">
              ...
              <span class="style-ih1tlgxx_text-wrapper">
                <span id="anchor-label_1" class="style-ih1tlgxx_label" style="color:#E40404;">ACCUEIL</span>
              </span>
            </a>
          </li>
          <li class="style-ih1tlgxx_item style-ih1tlgxx_active">
            <a class="style-ih1tlgxx_link" aria-labelledby="anchor-label_2" href="#shop" target="_self" data-keep-roots="true" data-anchor="dataItem-igqd45sx">
              ...
              <span class="style-ih1tlgxx_text-wrapper">
                <span id="anchor-label_2" class="style-ih1tlgxx_label" style="color:#E40404;">BOUTIQUE</span>
              </span>
            </a>
          </li>
          <li class="style-ih1tlgxx_item">
            <a class="style-ih1tlgxx_link" aria-labelledby="anchor-label_3" href="#about" target="_self" data-keep-roots="true" data-anchor="dataItem-igqd85721">
              ...
              <span class="style-ih1tlgxx_text-wrapper">
                <span id="anchor-label_3" class="style-ih1tlgxx_label" style="color:#E40404;">A PROPOS</span>
              </span>
            </a>
          </li>
          <li class="style-ih1tlgxx_item">
            <a class="style-ih1tlgxx_link" aria-labelledby="anchor-label_4" href="#contact" target="_self" data-keep-roots="true" data-anchor="dataItem-igqd8xa9">
              ...
              <span class="style-ih1tlgxx_text-wrapper">
                <span id="anchor-label_4" class="style-ih1tlgxx_label" style="color:#E40404;">CONTACT</span>
              </span>
            </a>
          </li>
        </ul>
  		...
  		<div class="case3" id="about" name="about">
  			<div class="parti02">
                ...
                <br>
   						 	<h1>A PROPOS</h1>
   						 	<br>
   						 	<p style="text-align: center;">Fantastique, joyeux, amical et plein de surprises inoubliables. Notre première édition d'Escapade Coffret vous fera découvrir parmi les meilleurs goûts et saveurs du territoire français. De la conception de la boîte à son contenu, nos coffrets en édition limitée ont tous été travaillés individuellement. Pour offrir ou pour soi-même, Escapade Coffrets contient un panel incroyable de souvenirs à retenir, ou à créer dans votre prochaine Escapade française.</p>
