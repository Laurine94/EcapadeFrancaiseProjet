   ...
   <div class="case2">
     <div class="container">
       <div class="row">
         <div class="col-md-6">
           <div class="box1">
              <img src="img/cadeaux/cadeau5.jpg" class="img-thumbnail">
         ...
         <div class="col-md-6">
           <div class="box2">
             <h1>COFFRET NORMANDIE BRETAGNE</h1>
             <br>
             <br>
             <br>
             <p>UGS : 0006</p>
            ...
            <div class="modal-content">
              ...
              <img src="img/cadeaux/cadeau5.jpg " class="img-thumbnail" width="300px;" height="400px;" style="align-items: center; margin-left:13%" class="zoom">
              <div class="modal-body">
                    <br>
                    <p style="font-weight:bold;">COFFRET NORMANDIE BRETAGNE</p>
                    <br>
                    <P>Quantité :</P>
                    <br>
                    <p>Prix : </p>
