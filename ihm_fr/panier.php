    ...
    <body style="font-family:'Montserrat', sans-serif;">
        ...
        <br>
             ...
             <!-- <a href="coffrets_panier.php" class="previous">&laquo; Previous</a>-->
              <h2 style="margin-left:8%;">MON PANIER</h2>
                        ...
                        <table class="table">
							...
							?>
                                <tr>
                                    ...
                                    <td><button id="btn1" type="submit"><a href="panier.php?delPanier=<?= $coffret->id; ?>" class="del" style="color:white;">Supprimer</a></button>
                                    </td>
                                </tr>	
							<?php endforeach; ?>
                            </tbody>                            
                        </table>
                        <input type="submit" style="margin-top:3%; margin-left:0.7%;background-color:#183e67; color:white;" value="Mettre à jour le panier">  
                    </div>
                    <tr>
     ...
     <div class="container">
       <div class="row">
         ...
         <div class="col-md-6">
           ...
           <button type="button" class="button" data-toggle="modal" data-target="#mmyModal" style="background-color: #183e67; color: white; width: 200px; height: 50px; align-items: right; margin-left:65%; font-size:14pt;">Paiement</button>
                <!-- Modal -->
                       ...
                       <!-- Modal content-->
                          <div class="modal-content" style="top:-32px;">
                                <div class="modal-body">
                                      <p style="text-align: center; color: #B0A171 font-size:30px;">VALIDATION DU PAIEMENT</p>
                                      <br>
                                      <hr>

                                      <fieldset>
                                      <form action="bankcard.php" method="POST">
                                      <p>Nom : <input type="text" name="name" size="19px;" style="margin-left:20px;">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Prénom : <input type="text" name="prenom" size="19px;" style="margin-left: 20px;">
                                      <hr>  
                                      </p>
                                      <p>Adresse : <input type="text" name="addresse" size="64px;" style="margin-left:20px;">
                                      <br><br>
                                      Code postal : <input type="text" name="codepostal" size="6px;" style="margin-left:20px;">&emsp;&emsp;&emsp;&emsp;&emsp;Ville : <input type="text" name="ville" size="31px;" style="margin-left: 20px;">
                                      </p>
                                      <hr>
                                      </p>
                                      ...
                                      <p>Mode de paiement :&emsp;&emsp;
                                          <label class="radio-inline">
                                                 <input type="radio" name="optradio"><img src="img/payment/cb.jpg" width="34px;" height="27px;"> Carte bancaire
                                      ...
                                      <br>
                                      <p>Numéro de carte : <input type="text" name="numerocard" size="50px;" style="margin-left: 20px;"><br><br>
                                      Cryptogramme : <input type="text" name="syr" size="3px;" style="margin-left: 20px;">&emsp;&emsp;&emsp;&emsp;Date d'expiration : <input type="Date" name="date" size="40px;" style="margin-left: 20px;">
                                      </p>
                                      </fieldset>
                                      </form>
                                </div>
                                <div class="modal-footer">
                                      <button type="button" class="button" data-dismiss="modal"style="background-color:#183e67; color:white;">Confirmer</button>
                                      <button type="button" class="button" data-dismiss="modal" style="background-color:#183e67; color:white;">Annuler</button>
                                </div>
                          </div>
                      </div>
                  </div>
