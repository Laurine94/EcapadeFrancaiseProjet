...
<?php 
   ...
   echo '<div class="panier" id="sticky"><a href="confirm.php" title="Check your reservation"><p><U><strong>Your Reservation :</strong></U> &nbsp;&nbsp;&nbsp; Guesthouses (' . $nb_guesthouse . ') | Activities (' . $nb_activity . ')</p></a></div>';
?>